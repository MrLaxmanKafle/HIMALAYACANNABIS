...
export default function HomePage() {
  return (
    <>
      ...
      {/* Origin — the differentiator, stated without overclaiming */}
        ...
        <div className="grid gap-14 lg:grid-cols-[1fr_1.15fr]">
          <div>
            ...
            <p className="mt-6 leading-relaxed text-ink-2">
              ...
              into the plant, and from there into the oil. That makes soil
              history the single largest quality risk in this crop, and the
              reason consignments get turned away at borders.
            </p>
            <p className="mt-4 leading-relaxed text-ink-2">
              Much of the farmland in this valley has never seen a synthetic
          ...
          <dl className="self-center">
            {[
              { k: "Soil heavy metals", v: "Not yet measured", s: true },
              ...
              >
                ...
                <dd
                  className={`text-sm font-semibold ${row.s ? "text-ink-3" : "text-ink"}`}
                >
                  {row.v}
                </dd>
              </div>
            ...
            <p className="mt-5 text-sm leading-relaxed text-ink-3">
              Four of seven unmeasured, and said so. Every figure on this site
              carries its status until the dated laboratory result exists.
            </p>
          </dl>
        </div>
      </section>
