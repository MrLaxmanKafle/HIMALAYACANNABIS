...
*This blueprint lives at `docs/diaspora-superapp/BLUEPRINT.md` on the
`claude/nepali-diaspora-social-superapp-97q8hj` branch. Treat it as a living
document — revise the post-mortem and metrics as real data arrives.*
